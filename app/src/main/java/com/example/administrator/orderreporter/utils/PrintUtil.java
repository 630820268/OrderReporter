...
import com.example.administrator.orderreporter.print.PicFromPrint;
...
public class PrintUtil {
    ...
    public void print(byte[] bs) throws IOException {
        ...
        mOutputStream.write(boldOn(), 0, boldOn().length);
    }
    ...
    public void printBitmap(Bitmap bmp) throws IOException {
        bmp = compressPic(bmp);
        //byte[] bmpByteArray = PicFromPrint.draw2PxPoint(bmp);
    ...
    public static void printTest(BluetoothSocket bluetoothSocket,String compName,String orderId,String money,Bitmap bitmap) {
       // public static void printTest(BluetoothSocket bluetoothSocket, Bitmap bitmap) {
        try {
            ...
            pUtil.printLargeText("闪捷支付");
            pUtil.printLine(2);


            pUtil.printAlignment(1);
            pUtil.printMiddleText(compName);
            pUtil.printLine(2);

            pUtil.printDashLine();
            pUtil.printLine();

            pUtil.printTwoColumn("下单时间:",DateUtils.getTime() + "" );

            pUtil.printDashLine();
            pUtil.printLine(2);
//
            pUtil.printTwoColumn("订单号:", orderId);
            pUtil.printLine(3);


 //           pUtil.printTwoColumn("订单金额:","");
            pUtil.printAlignment(1);
            pUtil.printMiddleText("订单金额:"+money+"元");
//            pUtil.printAlignment(2);
//            pUtil.printMiddleText(money+"元");
            pUtil.printLine(2);
